#  first-vue-app mac 安装nodejs ，[官网教程](https://cn.vuejs.org/v2/guide/)   [下载pkg安装](https://nodejs.org/en/download/)，在vscode 安装 Vetur插件,ESLint 插件为ES代码拼写检查,TSLint 插件为TS代码拼写检查
